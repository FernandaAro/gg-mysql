...
-- Exercício 4 - Uma lista com todos os dados de todas as mulheres que nasceram no Brasil e que tem seu nome iniciando com a letra J
select * from gafanhotos 
where nome like 'J%' and nacionalidade = 'Brasil' and sexo = 'F';

-- Exercício 5 - Uma lista com o nome e nacionalidade de todos os homens que tem Silva no nome, não nasceram no Brasil e pesam menos de 100kg
...
-- Exercício 9 - Quantas gafanhotas mulheres tem mais de 1.90cm de altura?
